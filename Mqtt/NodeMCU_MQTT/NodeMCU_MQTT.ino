...
// WIFI
const char* SSID = "cativeiro"; // SSID / nome da rede WI-FI que deseja se conectar
const char* PASSWORD = "/EiCaralho123"; // Senha da rede WI-FI que deseja se conectar
 
// MQTT
const char* BROKER_MQTT = "192.168.0.106"; //URL do broker MQTT que se deseja utilizar
